...
import com.yizw.newhouselevy.Entity.HouseConfirm;
	...
	/**集体个人-产权调换-调查确认表*/
	public class CONFIRM_JTGR_PRO_MON_Bus {
	DatabaseHelper helper;
				
	public CONFIRM_JTGR_PRO_MON_Bus(DatabaseHelper databaseHelper){
	...
	public static String savePerson(Context context,CONFIRM_PERSON person) throws MyException{
		...
		UploadMsg msg = new UploadMsg();
		UploadCmd cmd = MsgHelper.buildUploadCmd("SAVE_PRO_FAMILY_REGLIST", person);
		msg.addCmd(cmd);
