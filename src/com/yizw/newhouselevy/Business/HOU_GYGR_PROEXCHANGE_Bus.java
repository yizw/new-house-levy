...
import com.yizw.newhouselevy.Entity.HouseList;
   ...
   /**国有个人-产权调换补偿计算单*/
   public class HOU_GYGR_PROEXCHANGE_Bus {

		DatabaseHelper helper;
		
		public HOU_GYGR_PROEXCHANGE_Bus(DatabaseHelper databaseHelper){
			this.helper = databaseHelper;
		}
		
		public void create(HouseList entity) throws MyException, SQLException{
			UploadMsg msg = new UploadMsg();
			UploadCmd cmd = MsgHelper.buildUploadCmd("SAVE_GYGR_PROEXCHANGE_COPTA", entity);
			msg.addCmd(cmd);
