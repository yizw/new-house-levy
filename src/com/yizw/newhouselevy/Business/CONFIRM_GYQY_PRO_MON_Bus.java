...
import com.yizw.newhouselevy.Entity.HouseConfirm;
	...
	/**国有企业-产权调换-货币补偿-调查确认表*/
	public class CONFIRM_GYQY_PRO_MON_Bus {

			DatabaseHelper helper;
			
			public CONFIRM_GYQY_PRO_MON_Bus(DatabaseHelper databaseHelper){
				this.helper = databaseHelper;
			}
			
			public void create(HouseConfirm entity) throws MyException, SQLException{
				UploadMsg msg = new UploadMsg();
				UploadCmd cmd = MsgHelper.buildUploadCmd("SAVE_CONFIRM_GYQY_PRO_MON", entity);
				msg.addCmd(cmd);
