...
import com.yizw.newhouselevy.Entity.HouseList;
   ...
   /**集体个人-货币补偿补偿计算单*/
   public class HOU_JTGR_MONETARY_Bus {

		DatabaseHelper helper;
		
		public HOU_JTGR_MONETARY_Bus(DatabaseHelper databaseHelper){
			this.helper = databaseHelper;
		}
		
		public void create(HouseList entity) throws MyException, SQLException{
			UploadMsg msg = new UploadMsg();
			UploadCmd cmd = MsgHelper.buildUploadCmd("SAVE_JTGR_MONETARY_COPTA", entity);
			msg.addCmd(cmd);
