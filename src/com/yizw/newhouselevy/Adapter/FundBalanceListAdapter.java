...
public class FundBalanceListAdapter extends BaseAdapter {

	private Context context;
	private DataTableList list;
	
	
	public FundBalanceListAdapter(Context context,DataTableList list){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (v == null) {
			...
			v = vi.inflate(R.layout.fund_balance_list_item, null);
		}
