...
public class HouseBnoListAdapter extends BaseAdapter {

	private Context context;
	private DataTableList list;
	
	
	public HouseBnoListAdapter(Context context,DataTableList list){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (v == null) {
			...
			v = vi.inflate(R.layout.house_bno_list_item, null);
		}
