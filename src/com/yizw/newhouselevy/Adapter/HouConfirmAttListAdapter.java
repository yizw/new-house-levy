...
/*确认表 附件一  列表   适配*/
public class HouConfirmAttListAdapter extends BaseAdapter {

	private Context context;
	private DataTableList list;
	
	
	public HouConfirmAttListAdapter(Context context,DataTableList list){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (v == null) {
			...
			v = vi.inflate(R.layout.hou_confirm_att_item, null);
		//	v.setClickable(true);
		}
	...
	//	PublicBus.fillText(v, R.id.txt_name,name);		
		//名称
		PublicBus.fillText(v, R.id.txt_name,"名称："+name);
		//类别
