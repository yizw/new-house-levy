...
public class HouseProListAdapter extends BaseAdapter {

	private Context context;
	private DataTableList list;
	
	
	public HouseProListAdapter(Context context,DataTableList list){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (v == null) {
			...
			v = vi.inflate(R.layout.house_pro_list_item, null);
		}
