...
import com.yizw.newhouselevy.AsyncTask.GYGRProAsyncTask;
import com.yizw.newhouselevy.AsyncTask.GYGRProSaveAsyncTask;
import com.yizw.newhouselevy.AsyncTask.HouseRoomInfoGYGRDeleteAsyncTask;
import com.yizw.newhouselevy.Business.HOU_GYGR_PROEXCHANGE_Bus;
...
/**分户--国有个人--产权--补偿计算单*/
public class GYGRProExchangeA extends OrmLiteBaseTabActivity<DatabaseHelper>{
	...
	public GYGRProExchangeA activity;
   ...
   //3月12日添加  
    ...
    edit_prohouseaera_x64input,
    
    edit_x600,edit_x601,edit_x602,edit_x603,edit_x604,edit_x605,edit_x606,edit_x607,
    //3月12日添加 
    edit_x608,edit_x609,
    edit_x610,edit_x611,edit_x612,edit_x613,edit_x614,edit_x615,edit_x616,edit_x617,edit_x618,edit_x619,
    
    
    //tab3    
    edit_value_x88_1,edit_num_x89,edit_num_x91,edit_num_x93,
    edit_cost_x95_1,edit_month_x96,edit_month_x98,edit_month_x100,
    edit_month_x102,edit_month_x104,edit_cost_x170, 
    edit_area_x164,edit_area_x165,edit_area_x166,edit_area_x167,edit_area_x208,edit_area_x209,
    edit_rise_x111_1,
    edit_money_x119,edit_money_x120,edit_price_x148,edit_housenum_x149,edit_money_x168,edit_money_x169,
    
    edit_x500,edit_x501,edit_x502,edit_x503,edit_x504,
    
    edit_value_x88_2,
    
    edit_a1000,edit_a1001,edit_a1002,
   ...
   //3月20日新增
    ...
    //tab4
    edit_area_x152,edit_value_x153,edit_area_x155,edit_value_x156,
    edit_area_x158,edit_value_x159,edit_area_x212,edit_value_x215,
    edit_area_x213,edit_value_x216,edit_area_x214,edit_value_x217,
    ...
    private TextView text_contractno_x185,text_levyname_x1,
   // text_cardno_x2,text_linktel_x3,
    text_maininquier_x218,  text_levyaddress_x4,
    ...
    text_structure_x201_1,text_area_x203,text_legalarea_x11,text_insidearea_x12,text_unregisterarea_x13,
    ...
    //tab2
    text_prohouseaera_x63,text_value_x67,text_value_x71,
    ...
    text_house_x40_1,text_existhouse_x41_1, text_house_x43,text_house_x44,text_house_x45,text_house_x46,text_area_x47,
    text_house_x40_2,text_existhouse_x41_2,text_house_x48,text_house_x49,text_house_x50,text_house_x51,text_area_x52, 
    text_house_x40_3,text_existhouse_x41_3,text_house_x53, text_house_x54,text_house_x55,text_house_x56,text_area_x57,
    text_house_x40_4,text_existhouse_x41_4, text_house_x58,text_house_x59, text_house_x60,text_house_x61,text_area_x62,
  //3月12日新增  期房 
    ...
    //tab3
 //   text_legalarea_x11_2, text_prohouseaera_x63_2,text_residuearea_x1163,
    text_cost_x90,text_cost_x92,
    text_cost_x94,text_cost_x97,text_cost_x99,
    text_cost_x101,text_cost_x103,text_cost_x105,text_legalarea_x11_3,
    ...
    text_value_x86_4,text_cost_x118,text_structure_x200_4,text_value_x204_4,
    text_cost_x210,text_structure_x201_4,text_value_x205_4,
    text_cost_x211,text_money_x150,text_money_x151, 
    
    text_value_x88_3,
      
    text_cost_x95_2,text_cost_x95_3,text_cost_x95_4,text_cost_x95_5,
    text_rise_x111_2,text_rise_x111_3,text_rise_x111_4,text_rise_x111_5,text_rise_x111_6,
    ...
    text_allowance_x157,text_structure_x81_5,text_allowance_x160,text_structure_x84_5,
    text_allowance_x223,text_structure_x200_5,text_allowance_x219,
    text_structure_x201_5,text_allowance_x220,text_totallowance_x161,
    text_totallowance_x162,text_totallowance_x163,text_totallowance_x162163,text_totallowance_x76_2,
    ...
    AlertDialog statusDialog = null;
	 ...
	 public void onPause(){
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			setContentView(R.layout.hou_gygr_proexchange);
			InitTabHost();
			initControl();
			operateIntent();
		}
	 ...
	 private void InitTabHost(){
			 ...
			 inflater.inflate(R.layout.hou_gygr_proexchange_tab1, tabHost.getTabContentView());
			 tabHost.addTab(tabHost.newTabSpec("tab1").setIndicator(getTabItemView(inflater,0,"一")).setContent(R.id.hou_gygr_proexchange_tab1));
		     tabHost.getTabWidget().getChildAt(0).setBackgroundResource(R.drawable.tab_item_bg);
		 
		     inflater.inflate(R.layout.hou_gygr_proexchange_tab2, tabHost.getTabContentView());
		     tabHost.addTab(tabHost.newTabSpec("tab2").setIndicator(getTabItemView(inflater,0,"二")).setContent(R.id.hou_gygr_proexchange_tab2));
		     tabHost.getTabWidget().getChildAt(1).setBackgroundResource(R.drawable.tab_item_bg);
		 
		     inflater.inflate(R.layout.hou_gygr_proexchange_tab3, tabHost.getTabContentView());
		     tabHost.addTab(tabHost.newTabSpec("tab3").setIndicator(getTabItemView(inflater,0,"三")).setContent(R.id.hou_gygr_proexchange_tab3));
		     tabHost.getTabWidget().getChildAt(2).setBackgroundResource(R.drawable.tab_item_bg);
		     
		     inflater.inflate(R.layout.hou_gygr_proexchange_tab4, tabHost.getTabContentView());
		     tabHost.addTab(tabHost.newTabSpec("tab4").setIndicator(getTabItemView(inflater,0,"四")).setContent(R.id.hou_gygr_proexchange_tab4));
	...
	//	text_linktel_x3 = (TextView) findViewById(R.id.text_linktel_x3);
		...
		text_area_x47 = (TextView) findViewById(R.id.text_area_x47);
		...
		text_area_x52 = (TextView) findViewById(R.id.text_area_x52);
		...
		text_area_x57 = (TextView) findViewById(R.id.text_area_x57);
		...
		text_area_x62 = (TextView) findViewById(R.id.text_area_x62);
		...
		edit_percent_x300 = (EditText) findViewById(R.id.edit_percent_x300);
		
		
		edit_x600 = (EditText) findViewById(R.id.edit_x600);
		edit_x601 = (EditText) findViewById(R.id.edit_x601);
		edit_x602 = (EditText) findViewById(R.id.edit_x602);
		edit_x603 = (EditText) findViewById(R.id.edit_x603);
		edit_x604 = (EditText) findViewById(R.id.edit_x604);
		edit_x605 = (EditText) findViewById(R.id.edit_x605);
		edit_x606 = (EditText) findViewById(R.id.edit_x606);
		edit_x607 = (EditText) findViewById(R.id.edit_x607);
		
		edit_x608 = (EditText) findViewById(R.id.edit_x608);
		edit_x609 = (EditText) findViewById(R.id.edit_x609);
		edit_x610 = (EditText) findViewById(R.id.edit_x610);
		edit_x611 = (EditText) findViewById(R.id.edit_x611);
		edit_x612 = (EditText) findViewById(R.id.edit_x612);
		edit_x613 = (EditText) findViewById(R.id.edit_x613);
		edit_x614 = (EditText) findViewById(R.id.edit_x614);
		edit_x615 = (EditText) findViewById(R.id.edit_x615);
		edit_x616 = (EditText) findViewById(R.id.edit_x616);
		edit_x617 = (EditText) findViewById(R.id.edit_x617);
		edit_x618 = (EditText) findViewById(R.id.edit_x618);
		edit_x619 = (EditText) findViewById(R.id.edit_x619);
		
		edit_prohouseaera_x64input = (EditText) findViewById(R.id.edit_prohouseaera_x64input);
		
		text_value_x69_2 = (TextView) findViewById(R.id.text_value_x69_2);
		...
		edit_a1000 = (EditText) findViewById(R.id.edit_a1000);
		edit_a1001 = (EditText) findViewById(R.id.edit_a1001);
		edit_a1002 = (EditText) findViewById(R.id.edit_a1002);
	  ...
	  //text_legalarea_x11_2 = (TextView) findViewById(R.id.text_legalarea_x11_2);
	  ...
	  //text_residuearea_x1163 = (TextView) findViewById(R.id.text_residuearea_x1163);
		...
		text_legalarea_x11_3 = (TextView) findViewById(R.id.text_legalarea_x11_3);
	...
	private void operateIntent() {
		...
		if (StringHelper.isNullOrEmpty(in_id)) {
			...
			GYGRProAsyncTask task = new GYGRProAsyncTask(activity);
			task.execute(in_id);
			setEntityToUI(entity, c);
...
//			btn.setVisibility(View.INVISIBLE);
	...
	//	text_linktel_x3.setText(entity.getX3());
		...
		// tab2 产权调换房屋+产权调换房屋大于或小于被征收房屋时的处理
		...
		text_area_x47.setText(entity.getX47() + "");
		...
		text_area_x52.setText(entity.getX52() + "");
		...
		text_area_x57.setText(entity.getX57() + "");
		...
		text_area_x62.setText(entity.getX62() + "");
		

		edit_percent_x300.setText(entity.getX300() + "");

		edit_prohouseaera_x65.setText(entity.getX65() + "");
		edit_value_x66.setText(DouToStr.format(entity.getX66()));
		edit_prohouseaera_x68.setText(entity.getX68() + "");
		edit_value_x69_1.setText(DouToStr.format(entity.getX69()));
		edit_percent_x70.setText(entity.getX70() + "");
		edit_prohouseaera_x72.setText(entity.getX72() + "");

		text_value_x69_2.setText(DouToStr.format(entity.getX69()));
		
		
		//产权调换房屋公摊系数
		edit_x600.setText(entity.getX600() + "");
		edit_x601.setText(entity.getX601() + "");
		edit_x602.setText(entity.getX602() + "");
		edit_x603.setText(entity.getX603() + "");
		edit_x604.setText(entity.getX604() + "");
		edit_x605.setText(entity.getX605() + "");
		edit_x606.setText(entity.getX606() + "");
		edit_x607.setText(entity.getX607() + "");
		
		
		edit_x608.setText(entity.getX608() + "");
		edit_x609.setText(entity.getX609() + "");
		edit_x610.setText(entity.getX610() + "");
		edit_x611.setText(entity.getX611() + "");
		edit_x612.setText(entity.getX612() + "");
		edit_x613.setText(entity.getX613() + "");
		edit_x614.setText(entity.getX614() + "");
		edit_x615.setText(entity.getX615() + "");
		edit_x616.setText(entity.getX616() + "");
		edit_x617.setText(entity.getX617() + "");
		edit_x618.setText(entity.getX618() + "");
		edit_x619.setText(entity.getX619() + "");
		
		//超安面积
		edit_prohouseaera_x64input.setText(entity.getX64input() + "");

		edit_percent_x74.setText(entity.getX74() + "");
		edit_prohouseaera_x77.setText(entity.getX77() + "");
		edit_prohouseaera_x79.setText(entity.getX79() + "");
		edit_prohouseaera_x82.setText(entity.getX82() + "");
		edit_prohouseaera_x85.setText(entity.getX85() + "");
		edit_prohouseaera_x221.setText(entity.getX221() + "");
		edit_prohouseaera_x222.setText(entity.getX222() + "");

		text_prohouseaera_x63.setText(entity.getX63() + "");
		...
		edit_a1000.setText(entity.getA1000() + "");
		edit_a1001.setText(entity.getA1001() + "");
		edit_a1002.setText(entity.getA1002() + "");
		
		edit_x500.setText(entity.getX500() + "");
		edit_x501.setText(entity.getX501() + "");
		edit_x502.setText(entity.getX502() + "");
		edit_x503.setText(entity.getX503() + "");
		edit_x504.setText(entity.getX504() + "");
		...
		edit_cost_x95_1.setText(entity.getX95() + "");
		...
		edit_cost_x170.setText(entity.getX170() + "");
		edit_area_x164.setText(entity.getX164() + "");
		edit_area_x165.setText(entity.getX165() + "");
		edit_area_x166.setText(entity.getX166() + "");
		edit_area_x167.setText(entity.getX167() + "");
		edit_area_x208.setText(entity.getX208() + "");
		edit_area_x209.setText(entity.getX209() + "");
		...
		edit_price_x148.setText(entity.getX148() + "");
		...
		text_cost_x95_2.setText(entity.getX95() + "");
		text_cost_x95_3.setText(entity.getX95() + "");
		text_cost_x95_4.setText(entity.getX95() + "");
		text_cost_x95_5.setText(entity.getX95() + "");
		...
		//text_legalarea_x11_2.setText(c.getX11() + "");
		text_cost_x90.setText(DouToStr.format(entity.getX90()));
		//text_prohouseaera_x63_2.setText(entity.getX63() + "");
		text_cost_x92.setText(DouToStr.format(entity.getX92()));
		//text_residuearea_x1163.setText(entity.getX11_63() + "");
		text_cost_x94.setText(DouToStr.format(entity.getX94()));

		text_cost_x97.setText(DouToStr.format(entity.getX97_000()));
		
		text_cost_x99.setText(DouToStr.format(entity.getX99_000()));
		text_cost_x101.setText(DouToStr.format(entity.getX101_000()));
		
		text_cost_x103.setText(DouToStr.format(entity.getX103_000()));
		text_cost_x105.setText(DouToStr.format(entity.getX105_000()));
		text_legalarea_x11_3.setText(c.getX11() + "");
		text_cost_x106.setText(DouToStr.format(entity.getX106()));
		...
		text_money_x151.setText(DouToStr.format(entity.getX151()));

		// tab4
		edit_area_x152.setText(entity.getX152() + "");
		edit_value_x153.setText(DouToStr.format(entity.getX153()));
		edit_area_x155.setText(entity.getX155() + "");
		edit_value_x156.setText(DouToStr.format(entity.getX156()));
		edit_area_x158.setText(entity.getX158() + "");
		edit_value_x159.setText(DouToStr.format(entity.getX159()));
		edit_area_x212.setText(entity.getX212() + "");
		edit_value_x215.setText(DouToStr.format(entity.getX215()));
		edit_area_x213.setText(entity.getX213() + "");
		edit_value_x216.setText(DouToStr.format(entity.getX216()));
		edit_area_x214.setText(entity.getX214() + "");
		...
		text_area_x152.setText(entity.getX152() + "");
		text_area_x155.setText(entity.getX155() + "");
		text_area_x158.setText(entity.getX158() + "");
		text_area_x212.setText(entity.getX212() + "");
		text_area_x213.setText(entity.getX213() + "");
		text_area_x214.setText(entity.getX214() + "");
		...
		// 注意x107,x108,x109是单独加进去的

		text_totallowance_x162.setText(DouToStr.format(entity.getX162()));
		text_totallowance_x163.setText(DouToStr.format(entity.getX163()));
		text_totallowance_x162163.setText(DouToStr.format(entity.getX162X163()));
	...
	private HouseList getEntity() {
       ...
       //tab1
		...
		entity.setX300(StringToDouble(edit_percent_x300.getText().toString()));	
		...
		entity.setX601(StringToDouble(edit_x601.getText().toString()));
		entity.setX602(StringToDouble(edit_x602.getText().toString()));
		entity.setX603(StringToDouble(edit_x603.getText().toString()));
		entity.setX604(StringToDouble(edit_x604.getText().toString()));
		entity.setX605(StringToDouble(edit_x605.getText().toString()));
		entity.setX606(StringToDouble(edit_x606.getText().toString()));
		entity.setX607(StringToDouble(edit_x607.getText().toString()));
		
		entity.setX608(StringToDouble(edit_x608.getText().toString()));
		entity.setX609(StringToDouble(edit_x609.getText().toString()));
		entity.setX610(StringToDouble(edit_x610.getText().toString()));
		entity.setX611(StringToDouble(edit_x611.getText().toString()));
		entity.setX612(StringToDouble(edit_x612.getText().toString()));
		entity.setX613(StringToDouble(edit_x613.getText().toString()));
		entity.setX614(StringToDouble(edit_x614.getText().toString()));
		entity.setX615(StringToDouble(edit_x615.getText().toString()));
		entity.setX616(StringToDouble(edit_x616.getText().toString()));
		entity.setX617(StringToDouble(edit_x617.getText().toString()));
		entity.setX618(StringToDouble(edit_x618.getText().toString()));
		entity.setX619(StringToDouble(edit_x619.getText().toString()));
		
		
		//超安面积
		entity.setX64input(StringToDouble(edit_prohouseaera_x64input.getText().toString()));
	    ...
	    entity.setA1000(StringToDouble(edit_a1000.getText().toString()));
		entity.setA1001(StringToDouble(edit_a1001.getText().toString()));
		entity.setA1002(StringToDouble(edit_a1002.getText().toString()));
...
//		  HouseRoomInfoGYGRDeleteAsyncTask task = new HouseRoomInfoGYGRDeleteAsyncTask(activity,hid1);
//		  task.execute("");
//		}
		...
		//  if(newactivity()){
			...
			getEntity();
			String result = HOU_GYGR_PROEXCHANGE_Bus.check(entity);
			if (!result.equals("")) {
...
//		boolean newactivity(){
//			if(!StringHelper.isNullOrEmpty(c_id) && "1".equals(c_status)){
//				Toast.makeText(activity, "你的确认表未提交，不能保存算单了！", Toast.LENGTH_LONG).show();
//				return false;
//			}
//			return true;
//		}
	   ...
	   if("1".equals(c_status)){
		  ...
		  builder.setSingleChoiceItems(new String[] {"暂时保存"}, 0, new DialogInterface.OnClickListener() {  
					...
					builder.setPositiveButton("确认", new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog, int which) {
							// TODO Auto-generated method stub
							try { 
								GYGRProSaveAsyncTask save = new GYGRProSaveAsyncTask(activity);
								save.execute("");
							} catch (Exception e) {
								MyException myE = new MyException("保存出错", e.getMessage(),e.getStackTrace());
								ExceptionHelper.Operate(myE, true, activity);
		...
		void Onclick_btn_title_left() {
			...
			if ((!levyname.equals("")) || (!cardno.equals(""))) {
		        new AlertDialog.Builder(GYGRProExchangeA.this).setMessage("信息未保存，确认要关闭？")
