...
import com.yizw.newhouselevy.AsyncTask.GYQYMonAsyncTask;
import com.yizw.newhouselevy.AsyncTask.GYQYMonSaveAsyncTask;
import com.yizw.newhouselevy.Business.HOU_GYQY_MONETARY_Bus;
...
/**分户--国有企业--货币--补偿计算单*/
public class GYQYMonetaryCoptA extends OrmLiteBaseTabActivity<DatabaseHelper>{
	...
	public GYQYMonetaryCoptA activity;
	
	public HouseList entity;
	public HouseConfirm c;
	
	public HouseList gyqymonetarycopt;
    ...
    edit_area_x203,edit_value_x14_1,edit_value_x15_1,edit_value_x16_1,
    edit_value_x38_1,edit_value_x204_1,edit_value_x205_1,
  //  edit_x600,
    //tab2
    edit_area_x20,edit_area_x21_1,edit_area_x22_1,edit_area_x37_1,edit_area_x206_1,
    edit_area_x207_1,edit_cost_x23,edit_num_x24,edit_cost_x29,edit_cost_x31,edit_cost_x187,	
    edit_value_x212,
  ...
  //3月18日新需求，国有企业产权、国有企业货币、集体企业产权、集体企业货币，X107、X108、X109调整为手动录入
    ...
    //tab3
    edit_percent_x111,edit_cost_x39,edit_cost_x168,edit_cost_x169,
    //tab4
   ...
   //  text_cardno_x2,text_linktel_x3,
     ...
     text_value_x38_2,text_value_x65,text_structure_x200_3,text_value_x204_2,text_value_x208,
     ...
     text_percent_x111_2,text_percent_x111_3,text_percent_x111_4,
     text_percent_x111_5,text_percent_x111_6,
     text_structure_x7_4,text_area_x20,text_value_x14_3,text_value_x33,text_structure_x8_4,
     text_area_x21,text_value_x15_3,text_value_x34,text_structure_x81_4,text_area_x22,
     text_value_x16_3,text_value_x35,text_structure_x84_4,text_area_x37,text_value_x38_3,
     text_value_x36,text_structure_x200_4,text_area_x206,text_value_x204_3,text_value_x210,
     text_structure_x201_4,text_area_x207,text_value_x205_3,text_value_x211,
    
   // 3月18日新需求，删除国有企业货币X52_011，我隐藏了未删除，鬼才知道以后会不会又改回来。。
   //  text_cost_x52,
     //tab4		
     text_structure_x7_5,text_structure_x8_5,text_structure_x81_5,
     text_structure_x84_5,text_structure_x200_5,
     text_structure_x201_5,text_cost_x161,
     
     
     text_value_x154,text_value_x157,text_value_x160,
     text_value_x223,text_value_x219,text_value_x220,
     
     text_area_x152,text_area_x155,text_area_x158,text_area_x212,
     text_area_x213,text_area_x214,
     ...
     text_cost_x63,text_cost_x52_2,text_cost_x64;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.hou_gyqy_monetary);
		InitTabHost();
		initControl();
		operateIntent();
	}
	...
	private void InitTabHost() {
		...
		inflater.inflate(R.layout.hou_gyqy_monetary_tab1, tabHost.getTabContentView());
		tabHost.addTab(tabHost.newTabSpec("tab1").setIndicator(getTabItemView(inflater,0,"一")).setContent(R.id.hou_gyqy_monetary_tab1));
		tabHost.getTabWidget().getChildAt(0).setBackgroundResource(R.drawable.tab_item_bg);
		 
		inflater.inflate(R.layout.hou_gyqy_monetary_tab2, tabHost.getTabContentView());
		tabHost.addTab(tabHost.newTabSpec("tab2").setIndicator(getTabItemView(inflater,0,"二")).setContent(R.id.hou_gyqy_monetary_tab2));
		tabHost.getTabWidget().getChildAt(1).setBackgroundResource(R.drawable.tab_item_bg);
		 
		inflater.inflate(R.layout.hou_gyqy_monetary_tab3, tabHost.getTabContentView());
		tabHost.addTab(tabHost.newTabSpec("tab3").setIndicator(getTabItemView(inflater,0,"三")).setContent(R.id.hou_gyqy_monetary_tab3));
		tabHost.getTabWidget().getChildAt(2).setBackgroundResource(R.drawable.tab_item_bg);
		     
		inflater.inflate(R.layout.hou_gyqy_monetary_tab4, tabHost.getTabContentView());
		tabHost.addTab(tabHost.newTabSpec("tab4").setIndicator(getTabItemView(inflater,0,"四")).setContent(R.id.hou_gyqy_monetary_tab4));
	...
	//	edit_linktel_x3 = (EditText) findViewById(R.id.edit_linktel_x3);
		...
		edit_value_x38_1 = (EditText) findViewById(R.id.edit_value_x38_1);
	...
	//	edit_x600 = (EditText) findViewById(R.id.edit_x600);
		...
		edit_cost_x31 = (EditText) findViewById(R.id.edit_cost_x31);
		edit_cost_x187 = (EditText) findViewById(R.id.edit_cost_x187);
		edit_value_x212 = (EditText) findViewById(R.id.edit_value_x212);
		//3月18日新增
...
//			GYQYMonAsyncTask task = new GYQYMonAsyncTask(activity);
//			task.execute(in_id);
  ...
  /** 将国有企业 货币补偿计算单的信息展现到UI*/	
   public void setEntityToUI(HouseList entity,HouseConfirm c){
	 ...
	 //   edit_linktel_x3.setText(entity.getX3());
		...
		edit_value_x38_1.setText(DouToStr.format(entity.getX86()));
	...
	//	edit_x600.setText(entity.getX600() + "");
		...
		// tab2
		edit_area_x20.setText(DouToStr.format(entity.getX77()));
		edit_area_x21_1.setText(DouToStr.format(entity.getX79()));
		edit_area_x22_1.setText(DouToStr.format(entity.getX82()));
		edit_area_x37_1.setText(DouToStr.format(entity.getX85()));
		edit_area_x206_1.setText(DouToStr.format(entity.getX221()));
		edit_area_x207_1.setText(DouToStr.format(entity.getX222()));

		edit_value_x212.setText(DouToStr.format(entity.getX212_011()));

		edit_cost_x23.setText(DouToStr.format(entity.getX88()));
		edit_num_x24.setText(entity.getX89()+"");
		edit_cost_x29.setText(DouToStr.format(entity.getX95()));
		edit_cost_x31.setText(DouToStr.format(entity.getX171()));
		...
		// tab3
		edit_percent_x111.setText(DouToStr.format(entity.getX111()));
		...
		text_value_x38_2.setText(DouToStr.format(entity.getX86()));
		...
		//1月22日修改
	//	text_area_x13_1.setText(DouToStr.format(entity.getX13_011()));
		
		
		text_cost_x25.setText(DouToStr.format(entity.getX25_011()));
		...
		text_cost_x30.setText(DouToStr.format(entity.getX30_011()));
		...
		text_area_x20.setText(DouToStr.format(entity.getX77()));
		...
		text_area_x21.setText(DouToStr.format(entity.getX79()));
		...
		text_area_x22.setText(DouToStr.format(entity.getX82()));
		...
		text_area_x37.setText(DouToStr.format(entity.getX85()));
		text_value_x38_3.setText(DouToStr.format(entity.getX86()));
		text_value_x36.setText(DouToStr.format(entity.getX36_011()));
		text_structure_x200_4.setText(c.getX200());
		text_area_x206.setText(DouToStr.format(entity.getX221()));
	...
	//	text_cost_x52.setText(DouToStr.format(entity.getX52_011()));
		...
		text_cost_x63.setText(DouToStr.format(entity.getX63_011()));
		text_cost_x64.setText(DouToStr.format(entity.getX64_011()));
   ...
   private HouseList getEntity() {
	 ...
	 //   entity.setX3(edit_linktel_x3.getText().toString());
		...
		entity.setX86(StringToDouble(edit_value_x38_1.getText().toString()));
	...
	//	entity.setX600(StringToDouble(edit_x600.getText().toString()));
		...
		// tab2
		entity.setX77(StringToDouble(edit_area_x20.getText().toString()));
		entity.setX79(StringToDouble(edit_area_x21_1.getText().toString()));
		entity.setX82(StringToDouble(edit_area_x22_1.getText().toString()));
		entity.setX85(StringToDouble(edit_area_x37_1.getText().toString()));
		entity.setX221(StringToDouble(edit_area_x206_1.getText().toString()));
		entity.setX222(StringToDouble(edit_area_x207_1.getText().toString()));
		...
		entity.setX171(StringToDouble(edit_cost_x31.getText().toString()));
   ...
   private Double StringToDouble(String text) {
	...
	class OnClick implements View.OnClickListener {
		...
		void Onclick_btn_title_right() {
			getEntity();
			String result = HOU_GYQY_MONETARY_Bus.check(entity);
			if (!result.equals("")) {
		...
		void showTempSaveDialog(String message) {
			...
			builder.setTitle("国有企业货币算单提交或暂存");
		  ...
		  if("1".equals(c_status)){
		   ...
		   builder.setSingleChoiceItems(new String[] { "暂时保存"}, 0, new DialogInterface.OnClickListener() {
			...
			builder.setPositiveButton("确认",new DialogInterface.OnClickListener() {
			   ...
			   // TODO Auto-generated method stub
		          try {
		    	      GYQYMonSaveAsyncTask save = new GYQYMonSaveAsyncTask(activity);
		    	      save.execute("");
		    	         }catch (Exception e) {
		...
		void Onclick_btn_title_left() {
			if (isAdd == false) {
				GYQYMonetaryCoptA.this.finish();
				return;
			}
			// 新增国有企业货币补偿计算单信息时，按下返回，如果必填项姓名或证件号不为空则进行关闭确认
			if (isAdd) {
				...
				if ((!levyname.equals("")) || (!cardno.equals(""))) {
					// if((!levyname.equals(""))){
					new AlertDialog.Builder(GYQYMonetaryCoptA.this)
