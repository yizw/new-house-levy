...
import com.yizw.newhouselevy.UI.TimeControlA;

public class TimeControlAsyncTask extends AsyncTask<Void, String, HashMap<String, DataTableList>> {

	private TimeControlA activity;
	
	public TimeControlAsyncTask(TimeControlA activity){
