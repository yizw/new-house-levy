...
/*国有个人确认表保存*/
public class HouseConfirmGYGRSaveAsyncTask extends AsyncTask<String, String, RebackInfo> {
	
	private HouGYGRConfirmTable activity;
	AlertDialog statusDialog;
	
	public HouseConfirmGYGRSaveAsyncTask(HouGYGRConfirmTable activity){
