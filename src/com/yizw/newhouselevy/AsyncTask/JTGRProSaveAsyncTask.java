...
import com.yizw.newhouselevy.UI.JTGRProExchangeA;

/*集体个人   产权调换算单保存*/
public class JTGRProSaveAsyncTask extends AsyncTask<String, String, RebackInfo> {
	
	private JTGRProExchangeA activity;
	AlertDialog statusDialog;
	
	public JTGRProSaveAsyncTask(JTGRProExchangeA activity){
