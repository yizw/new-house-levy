...
import com.yizw.newhouselevy.UI.HouGYQYConfirmTable;

/*国有企业确认表保存*/
public class HouseConfirmGYQYSaveAsyncTask extends AsyncTask<String, String, RebackInfo> {
	
	private HouGYQYConfirmTable activity;
	AlertDialog statusDialog;
	
	public HouseConfirmGYQYSaveAsyncTask(HouGYQYConfirmTable activity){
