...
/*用户信息查询*/
public class MainUserInfoSearchAsyncTask extends AsyncTask<String, String, DataTableList> {

	private MainIndexA activity;
	AlertDialog statusDialog;
	
	public MainUserInfoSearchAsyncTask(MainIndexA activity){
	...
	protected DataTableList doInBackground(String... params) {
		...
		try {
			...
			UploadCmd cmd = new UploadCmd(CmdCode.SEARCH_USER_INFO);
