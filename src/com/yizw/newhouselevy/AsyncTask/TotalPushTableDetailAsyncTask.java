...
import com.yizw.newhouselevy.UI.TotalPushTableDetailA;

public class TotalPushTableDetailAsyncTask extends AsyncTask<Void, String, HashMap<String, DataTableList>> {
	
	private TotalPushTableDetailA activity;
	
	public TotalPushTableDetailAsyncTask(TotalPushTableDetailA activity){
	...
	protected HashMap<String, DataTableList> doInBackground(Void...params) {
		...
		try {
			...
			UploadCmd cmd = new UploadCmd(CmdCode.SEARCH_PROGRESS_MAINLIST); 
