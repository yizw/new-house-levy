...
public class HouseholdCoptSheetAsyncTask extends AsyncTask<Void, String, HashMap<String, DataTableList>> {

	private HouseholdCoptSheetA activity;
	
	public HouseholdCoptSheetAsyncTask(HouseholdCoptSheetA activity){
	...
	protected HashMap<String, DataTableList> doInBackground(Void...params) {
		try {
			...
			UploadCmd cmd = new UploadCmd(CmdCode.SEARCH_PRO_H_LIST);
