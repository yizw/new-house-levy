...
import com.yizw.newhouselevy.UI.ProQuestionListA;

/*问题反馈（项目） 问题列表查询*/
public class ProQuestionSearchAsyncTask extends AsyncTask<Void, String, HashMap<String, DataTableList>> {

	private ProQuestionListA activity;

	public ProQuestionSearchAsyncTask(ProQuestionListA activity) {
