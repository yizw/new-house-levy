...
import com.yizw.newhouselevy.UI.HListAttList;
...
/*算单   附件一  列表查询*/
public class HListAttListAsyncTask extends AsyncTask<Void, String, HashMap<String, DataTableList>> {

	private HListAttList activity;
	
	public HListAttListAsyncTask(HListAttList activity){
	...
	protected void onPostExecute(HashMap<String, DataTableList> result) {	
		if(result == null){
			...
			activity.allmoney = pageList.get(0).get("allmoney").toString();
			activity.allmoneyview.setText(activity.allmoney);
