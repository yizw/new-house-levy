...
import com.yizw.newhouselevy.UI.A_DemoListPageA;

/** 分页实现异步任务示例代码*/
public class A_DemoListPageAsyncTask extends AsyncTask<String, String, HashMap<String, DataTableList>>{

	private A_DemoListPageA activity;
	
	public A_DemoListPageAsyncTask(A_DemoListPageA activity){
	...
	@Override
	protected HashMap<String, DataTableList> doInBackground(String... params) {
		
		try {
			MessageUploader messageUploader = new MessageUploader(activity,new MsgConfig());
			
			//请求的页码为pageDomain.getNowPage()+1
