...
import com.yizw.newhouselevy.UI.HouseBnoListA;

/*房源-楼栋 列表查询*/
public class HouseBnoListAsyncTask extends AsyncTask<Void, String, HashMap<String, DataTableList>> {

	private HouseBnoListA activity;
	
	public HouseBnoListAsyncTask(HouseBnoListA activity){
	...
	protected HashMap<String, DataTableList> doInBackground(Void...params) {
		...
		try {
			...
			UploadCmd cmd = new UploadCmd(CmdCode.SEARCH_HOUSEBNO);
