...
import com.yizw.newhouselevy.UI.ProProblemFeedbackListA;

	public class ProListAsyncTask extends AsyncTask<Void, String, HashMap<String, DataTableList>> {

		private ProProblemFeedbackListA activity;
		
		public ProListAsyncTask(ProProblemFeedbackListA activity){
