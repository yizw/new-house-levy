...
public class TotalPushTableListAsyncTask extends AsyncTask<Void, String, HashMap<String, DataTableList>> {

	private TotalPushTableListA activity;
	
	public TotalPushTableListAsyncTask(TotalPushTableListA activity){
