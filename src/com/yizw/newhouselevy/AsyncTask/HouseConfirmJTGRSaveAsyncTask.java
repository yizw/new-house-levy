...
/*集体个人确认表保存*/
public class HouseConfirmJTGRSaveAsyncTask extends AsyncTask<String, String, RebackInfo> {
	
	private HouJTGRConfirmTable activity;
	AlertDialog statusDialog;
	
	public HouseConfirmJTGRSaveAsyncTask(HouJTGRConfirmTable activity){
