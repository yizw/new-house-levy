...
/*房源-查询到房间详细信息*/
public class HouseRoomInfoSearchAsyncTask extends AsyncTask<String, String, DataTableList> {

	private HouseRoomInfoA activity;
	AlertDialog statusDialog;
	
	public HouseRoomInfoSearchAsyncTask(HouseRoomInfoA activity){
	...
	protected DataTableList doInBackground(String... params) {
		...
		try {
			...
			UploadCmd cmd = new UploadCmd(CmdCode.SEARCH_HOUSE_ROOM_INFO);
