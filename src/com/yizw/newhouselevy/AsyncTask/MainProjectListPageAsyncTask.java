...
public class MainProjectListPageAsyncTask extends AsyncTask<Void, String, HashMap<String, DataTableList>> {

	private MainProjectListA activity;
	
	public MainProjectListPageAsyncTask(MainProjectListA activity){
