...
import com.yizw.newhouselevy.UI.HouseUnitListA;

/*房源-单元 列表查询*/
public class HouseUnitListAsyncTask extends AsyncTask<Void, String, HashMap<String, DataTableList>> {

	private HouseUnitListA activity;
	
	public HouseUnitListAsyncTask(HouseUnitListA activity){
	...
	protected HashMap<String, DataTableList> doInBackground(Void...params) {
		...
		try {
			...
			UploadCmd cmd = new UploadCmd(CmdCode.SEARCH_HOUSEUNIT);
