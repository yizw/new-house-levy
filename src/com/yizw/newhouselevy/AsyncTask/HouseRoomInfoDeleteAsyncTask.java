...
/*集体个人产权-删除已经选择的房源信息*/
public class HouseRoomInfoDeleteAsyncTask extends AsyncTask<String, String, RebackInfo> {

	private JTGRProExchangeA activity;
	AlertDialog statusDialog;
	private String hid;
	
	public HouseRoomInfoDeleteAsyncTask(JTGRProExchangeA activity,String hid){
