...
public class DataBaseListPageAsyncTask extends AsyncTask<Void, String,  HashMap<String, DataTableList>> {
	
	private DataBaseListA activity;
	
	public DataBaseListPageAsyncTask(DataBaseListA activity){
	...
	protected HashMap<String, DataTableList> doInBackground(Void...params) {
		...
		try {
			...
			UploadCmd cmd = new UploadCmd(CmdCode.SEARCH_DATABASEPAGE);
