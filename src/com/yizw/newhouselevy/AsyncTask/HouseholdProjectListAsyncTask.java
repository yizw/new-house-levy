...
public class HouseholdProjectListAsyncTask extends AsyncTask<Void, String,  HashMap<String, DataTableList>> {
	
	private HouseholdProjectListA activity;
	
	public HouseholdProjectListAsyncTask(HouseholdProjectListA activity){
