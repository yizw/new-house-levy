...
public class GYGRFamilyRegListAsyncTask extends AsyncTask<Void, String, HashMap<String, DataTableList>> {
...
//	}
	...
	public GYGRFamilyRegListAsyncTask(HouGYGRConfirmTable activity){
		this.activity = activity; 
	}
