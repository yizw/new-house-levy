...
import com.yizw.newhouselevy.UI.HouConfirmAttListA;

/*确认表 附件一  列表查询*/
public class HouConfirmAttListAsyncTask extends AsyncTask<Void, String, HashMap<String, DataTableList>> {

	private HouConfirmAttListA activity;
	
	public HouConfirmAttListAsyncTask(HouConfirmAttListA activity){
	...
	protected HashMap<String, DataTableList> doInBackground(Void...params) {
		...
		try {
			...
			UploadCmd cmd = new UploadCmd(CmdCode.SEARCH_CONFIRM_ATT_LIST);
