...
import com.yizw.newhouselevy.UI.HouJTGRConfirmTable;

public class FamilyRegListAsyncTask extends AsyncTask<Void, String, HashMap<String, DataTableList>> {

	private HouJTGRConfirmTable activity;
...
//	}
	...
	public FamilyRegListAsyncTask(HouJTGRConfirmTable activity){
		this.activity = activity; 
	}
