...
/*确认表   附件一   item  信息保存*/
public class HouConfirmAttInfoSaveAsyncTask  extends AsyncTask<String, String, RebackInfo> {

	private HouConfirmAttInfoA activity;
	AlertDialog statusDialog;
	
	public HouConfirmAttInfoSaveAsyncTask(HouConfirmAttInfoA activity){
	...
	protected RebackInfo doInBackground(String... params) {
		...
		try {
			...
			UploadCmd cmd = MsgHelper.buildUploadCmd("SAVE_CONFIRM_ATT_INFO", activity.entity);
