...
import com.yizw.newhouselevy.UI.GYQYProExchangeA;
...
/*国有企业  产权调换算单保存*/
public class GYQYProSaveAsyncTask extends AsyncTask<String, String, RebackInfo> {
	
	private GYQYProExchangeA activity;
	AlertDialog statusDialog;
	
	public GYQYProSaveAsyncTask(GYQYProExchangeA activity){
