...
/*房屋调查确认表 -- 房屋产权手续登记信息页面  查询*/
public class HouseConfirmRegInfoSearchAsyncTask extends AsyncTask<String, String, DataTableList> {

	private HouseConfirmRegInfoA activity;
	AlertDialog statusDialog;
	
	public HouseConfirmRegInfoSearchAsyncTask(HouseConfirmRegInfoA activity){
	...
	protected DataTableList doInBackground(String... params) {
		...
		try {
			...
			UploadCmd cmd = new UploadCmd(CmdCode.SEARCH_HOUSE_CONFIRM_REG_INFO);
