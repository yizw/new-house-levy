...
import com.yizw.newhouselevy.UI.JTGRMonetaryCoptA;

/*集体个人   货币补偿算单保存*/
public class JTGRMonSaveAsyncTask extends AsyncTask<String, String, RebackInfo> {
	
	private JTGRMonetaryCoptA activity;
	AlertDialog statusDialog;
	
	public JTGRMonSaveAsyncTask(JTGRMonetaryCoptA activity){
