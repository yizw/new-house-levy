...
import com.yizw.newhouselevy.UI.DataBaseInfoA;

public class DataBaseInfoSearchAsyncTask extends AsyncTask<String, String, DataTableList> {

	private DataBaseInfoA activity;
	AlertDialog statusDialog;
	
	public DataBaseInfoSearchAsyncTask(DataBaseInfoA activity){
	...
	protected DataTableList doInBackground(String... params) {
		...
		try {
			...
			UploadCmd cmd = new UploadCmd(CmdCode.SEARCH_DATABASE_INFO);
