...
import com.yizw.newhouselevy.UI.GYQYMonetaryCoptA;

/*国有企业  货币补偿算单保存*/
public class GYQYMonSaveAsyncTask extends AsyncTask<String, String, RebackInfo> {
	
	private GYQYMonetaryCoptA activity;
	AlertDialog statusDialog;
	
	public GYQYMonSaveAsyncTask(GYQYMonetaryCoptA activity){
