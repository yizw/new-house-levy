...
import com.yizw.newhouselevy.UI.ProReplyListA;

/*问题反馈（项目） 回复列表查询*/
public class ProReplySearchAsyncTask extends AsyncTask<Void, String, HashMap<String, DataTableList>> {

	private ProReplyListA activity;

	public ProReplySearchAsyncTask(ProReplyListA activity) {
