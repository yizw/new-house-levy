...
import com.yizw.newhouselevy.UI.ProReplyAdd;

/*问题反馈（项目） 回复 新增保存*/
public class ProReplySaveAsyncTask extends AsyncTask<String, String, RebackInfo> {

	private ProReplyAdd activity;
	AlertDialog statusDialog;
	
	public ProReplySaveAsyncTask(ProReplyAdd activity){
