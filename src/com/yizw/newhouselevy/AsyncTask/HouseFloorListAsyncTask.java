...
import com.yizw.newhouselevy.UI.HouseFloorListA;

/*房源-楼层信息查询*/
public class HouseFloorListAsyncTask extends AsyncTask<Void, String, HashMap<String, DataTableList>> {

	private HouseFloorListA activity;
	
	public HouseFloorListAsyncTask(HouseFloorListA activity){
	...
	protected HashMap<String, DataTableList> doInBackground(Void...params) {
		...
		try {
			...
			UploadCmd cmd = new UploadCmd(CmdCode.SEARCH_HOUSEFLOOR);
