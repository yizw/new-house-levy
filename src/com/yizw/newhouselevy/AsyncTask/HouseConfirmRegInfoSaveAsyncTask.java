...
import com.yizw.newhouselevy.UI.HouseConfirmRegInfoA;

/*房屋调查确认表 -- 房屋产权手续登记信息页面  保存*/
public class HouseConfirmRegInfoSaveAsyncTask extends AsyncTask<String, String, RebackInfo> {

	private HouseConfirmRegInfoA activity;
	AlertDialog statusDialog;
	
	public HouseConfirmRegInfoSaveAsyncTask(HouseConfirmRegInfoA activity){
	...
	protected RebackInfo doInBackground(String... params) {
		...
		try {
			...
			UploadCmd cmd = MsgHelper.buildUploadCmd("SAVE_HOUSE_CONFIRM_REG", activity.entity);
