...
import com.yizw.newhouselevy.UI.FundBalanceListA;

public class FundBalanceListAsyncTask extends AsyncTask<Void, String, HashMap<String, DataTableList>> {

	private FundBalanceListA activity;
	
	public FundBalanceListAsyncTask(FundBalanceListA activity){
