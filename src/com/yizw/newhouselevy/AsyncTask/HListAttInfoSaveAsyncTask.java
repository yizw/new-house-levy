...
/*算单 附件一   item  信息保存*/
public class HListAttInfoSaveAsyncTask extends AsyncTask<String, String, RebackInfo> {

	private HListAttInfo activity;
	AlertDialog statusDialog;
	
	public HListAttInfoSaveAsyncTask(HListAttInfo activity){
	...
	protected RebackInfo doInBackground(String... params) {
		...
		try {
			...
			UploadCmd cmd = MsgHelper.buildUploadCmd("SAVE_HLIST_ATT_INFO", activity.entity);
	//		UploadCmd cmd = new UploadCmd(CmdCode.SAVE_HLIST_ATT_INFO);
