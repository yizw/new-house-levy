...
import com.yizw.newhouselevy.UI.HouseConfirmRegListA;


/*房屋调查确认表 -- 房屋产权手续登记列表查询*/
public class HouseConfirmRegListSearchAsyncTask extends AsyncTask<Void, String, HashMap<String, DataTableList>> {

	private HouseConfirmRegListA activity;
	
	public HouseConfirmRegListSearchAsyncTask(HouseConfirmRegListA activity){
	...
	protected HashMap<String, DataTableList> doInBackground(Void...params) {
		...
		try {
			...
			UploadCmd cmd = new UploadCmd(CmdCode.SEARCH_HOUSE_CONFIRM_REG_LIST);
