...
import com.yizw.newhouselevy.UI.TimeControlInfoA;

public class TimeInfoSearchAsyncTask extends AsyncTask<String, String, DataTableList> {

	private TimeControlInfoA activity;
	AlertDialog statusDialog;
	
	public TimeInfoSearchAsyncTask(TimeControlInfoA activity){
	...
	protected DataTableList doInBackground(String... params) {
		...
		try {
			...
			UploadCmd cmd = new UploadCmd(CmdCode.SEARCH_TIMECONTROL_INFO);
