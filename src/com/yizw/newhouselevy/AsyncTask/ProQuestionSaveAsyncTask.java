...
import com.yizw.newhouselevy.UI.ProQuestionAdd;

/*问题反馈（项目） 问题新增保存*/
public class ProQuestionSaveAsyncTask extends AsyncTask<String, String, RebackInfo> {

	private ProQuestionAdd activity;
	AlertDialog statusDialog;
	
	public ProQuestionSaveAsyncTask(ProQuestionAdd activity){
	...
	protected RebackInfo doInBackground(String... params) {
		...
		try {
			...
			UploadCmd cmd = MsgHelper.buildUploadCmd("SAVE_PRO_PROFEEDBACK_QUESTION_INFO", activity.entity);
