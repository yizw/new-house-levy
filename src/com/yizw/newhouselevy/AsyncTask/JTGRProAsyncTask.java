...
public class JTGRProAsyncTask extends AsyncTask<String, String, DataTableList> {

	private JTGRProExchangeA activity;
	AlertDialog statusDialog;
	
	public JTGRProAsyncTask(JTGRProExchangeA activity){
	...
	protected DataTableList doInBackground(String... params) {
		...
		try {
			...
			cmd2.addParameter("hid", activity.in_hid);
			msg2.addCmd(cmd2);			
