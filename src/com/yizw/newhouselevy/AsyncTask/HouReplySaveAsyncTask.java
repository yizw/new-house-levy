...
import com.yizw.newhouselevy.UI.HouReplyAdd;

/*问题反馈（分户） 回复 新增保存*/
public class HouReplySaveAsyncTask extends AsyncTask<String, String, RebackInfo> {

	private HouReplyAdd activity;
	AlertDialog statusDialog;
	
	public HouReplySaveAsyncTask(HouReplyAdd activity){
	...
	protected RebackInfo doInBackground(String... params) {
		...
		try {
			...
			UploadCmd cmd = MsgHelper.buildUploadCmd("SAVE_PRO_PROFEEDBACK_REPLY_INFO", activity.entity);
			msg.addCmd(cmd);		 
