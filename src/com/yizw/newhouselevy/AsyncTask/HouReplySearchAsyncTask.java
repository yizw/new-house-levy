...
import com.yizw.newhouselevy.UI.HouReplyListA;

/*问题反馈（分户） 回复列表查询*/
public class HouReplySearchAsyncTask extends AsyncTask<Void, String, HashMap<String, DataTableList>> {

	private HouReplyListA activity;

	public HouReplySearchAsyncTask(HouReplyListA activity) {
	...
	protected HashMap<String, DataTableList> doInBackground(Void... params) {
		...
		try {
			...
			UploadCmd cmd = new UploadCmd(CmdCode.SEARCH_PROFEEDBACK_REPLY_INFO);
