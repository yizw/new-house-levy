...
public class HouseholdPushTableInfoAsyncTask extends AsyncTask<String, String, DataTableList> {

	private HouseholdPushTableInfoA activity;
	AlertDialog statusDialog;
	
	public HouseholdPushTableInfoAsyncTask(HouseholdPushTableInfoA activity){
	...
	protected DataTableList doInBackground(String... params) {
		...
		try {
			...
			UploadCmd cmd = new UploadCmd(CmdCode.SEARCH_PROGRESS_BRANCH_INFO);
