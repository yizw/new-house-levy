...
import com.yizw.newhouselevy.UI.HouQuestionAdd;

/*问题反馈（分户） 问题新增保存*/
public class HouQuestionSaveAsyncTask extends AsyncTask<String, String, RebackInfo> {

	private HouQuestionAdd activity;
	AlertDialog statusDialog;
	
	public HouQuestionSaveAsyncTask(HouQuestionAdd activity){
