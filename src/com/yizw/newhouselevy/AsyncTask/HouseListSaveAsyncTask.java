...
import com.yizw.newhouselevy.UI.GYGRMonetaryCoptA;
...
import android.widget.Toast;
  ...
  /*算单保存*/
  public class HouseListSaveAsyncTask extends AsyncTask<String, String, RebackInfo> {

	private GYGRMonetaryCoptA activity;
	AlertDialog statusDialog;
	
	public HouseListSaveAsyncTask(GYGRMonetaryCoptA activity){
	...
	protected RebackInfo doInBackground(String... params) {
		...
		try {
			...
			UploadCmd cmd = MsgHelper.buildUploadCmd("SAVE_PRO_H_LIST", activity.entity);
			msg.addCmd(cmd);		 
