...
import com.yizw.newhouselevy.UI.GYGRConfirmPerson;

/*集体个人、国有个人确认表保存户籍人口信息*/
public class GYGRFamilyRegSaveAsyncTask extends AsyncTask<String, String, RebackInfo> {

 	private GYGRConfirmPerson activity;
 //	private JTGRConfirmPerson activity;
	AlertDialog statusDialog;
	
	
	public GYGRFamilyRegSaveAsyncTask(GYGRConfirmPerson activity){
	...
	protected RebackInfo doInBackground(String... params) {
		...
		try {
			...
			UploadCmd cmd = MsgHelper.buildUploadCmd("SAVE_FAMILYREG", activity.entity);
			msg.addCmd(cmd);		 
