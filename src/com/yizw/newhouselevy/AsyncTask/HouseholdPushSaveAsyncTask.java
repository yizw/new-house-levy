...
import com.yizw.newhouselevy.UI.HouseholdPushTableInfoA;

/*分户推进表保存*/
public class HouseholdPushSaveAsyncTask extends AsyncTask<String, String, RebackInfo> {

	private HouseholdPushTableInfoA activity;
	AlertDialog statusDialog;
	
	public HouseholdPushSaveAsyncTask(HouseholdPushTableInfoA activity){
	...
	protected RebackInfo doInBackground(String... params) {
		...
		//	UploadCmd cmd = MsgHelper.buildUploadCmd(CmdCode.SAVE_PROGRESS_BRANCH, activity.entity);
			UploadCmd cmd = MsgHelper.buildUploadCmd("SAVE_PROGRESS_BRANCH", activity.entity);
			msg.addCmd(cmd);		 
