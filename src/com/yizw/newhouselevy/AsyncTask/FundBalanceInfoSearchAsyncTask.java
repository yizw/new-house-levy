...
import com.yizw.newhouselevy.UI.FundBalanceInfoA;

public class FundBalanceInfoSearchAsyncTask extends AsyncTask<String, String, DataTableList> {

	private FundBalanceInfoA activity;
	AlertDialog statusDialog;
	
	public FundBalanceInfoSearchAsyncTask(FundBalanceInfoA activity){
	...
	protected DataTableList doInBackground(String... params) {
		...
		try {
			...
			UploadCmd cmd = new UploadCmd(CmdCode.SEARCH_FUNDBALANCE_INFO);
