...
/*总推进表保存*/
public class TotalPushTableInfoSaveAsyncTask extends AsyncTask<String, String, RebackInfo> {

	private TotalPushTableInfoA activity;
	AlertDialog statusDialog;
	
	public TotalPushTableInfoSaveAsyncTask(TotalPushTableInfoA activity){
	...
	protected RebackInfo doInBackground(String... params) {
		...
		try {
			...
			UploadCmd cmd = MsgHelper.buildUploadCmd("SAVE_PROGRESS_MAIN", activity.entity);
			msg.addCmd(cmd);		 
