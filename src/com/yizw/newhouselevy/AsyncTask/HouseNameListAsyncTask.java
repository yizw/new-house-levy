...
/*房源-房开商 列表查询*/
public class HouseNameListAsyncTask extends AsyncTask<Void, String, HashMap<String, DataTableList>> {

	private HouseNameListA activity;
	
	public HouseNameListAsyncTask(HouseNameListA activity){
	...
	protected HashMap<String, DataTableList> doInBackground(Void...params) {
		...
		try {
			...
			UploadCmd cmd = new UploadCmd(CmdCode.SEARCH_H_HOUSE_LIST);
