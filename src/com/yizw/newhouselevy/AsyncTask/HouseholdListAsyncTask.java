...
public class HouseholdListAsyncTask extends AsyncTask<Void, String, HashMap<String, DataTableList>> {
...
//	}
	...
	public HouseholdListAsyncTask(HouseholdListA activity,String houseowner){
		this.activity = activity;
		this.houseowner = houseowner;
	}
	...
	protected HashMap<String, DataTableList> doInBackground(Void...params) {
		...
		try {
			...
			UploadCmd cmd = new UploadCmd(CmdCode.SEARCH_PRO_HOUSEHOLD_LIST);
			cmd.addParameter("pid", activity.pid);
			cmd.addParameter("houseowner",houseowner);
		//	cmd.addParameter("cartno",cardno);
