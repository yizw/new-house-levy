...
import com.yizw.newhouselevy.UI.JTQYProExchangeA;

/*集体企业  产权调换算单保存*/
public class JTQYProSaveAsyncTask extends AsyncTask<String, String, RebackInfo> {
	
	private JTQYProExchangeA activity;
	AlertDialog statusDialog;
	
	public JTQYProSaveAsyncTask(JTQYProExchangeA activity){
